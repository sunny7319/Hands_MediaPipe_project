...
# 게임 데이터를 파일에 저장하는 함수
def save_game_data(x_coor_web, y_coor_web,score_web,stage_web):
    print('호출됨')
    ...
    new_entry = {
        'id':1,
        'page':2,
        'x_coordinate': x_coor_web,
        'y_coordinate': y_coor_web,
            ...
            for hand_landmarks in result.multi_hand_landmarks:
                ...
                if is_rock_gesture(hand_landmarks, gesture_sensitivity, mp_hands):
                    ...
                    if abs(x_fist - new_location[0][0]) < click_sensitivity and abs(y_fist - new_location[0][1]) < click_sensitivity:
                        ...
                        save_game_data(x_coor_web, y_coor_web,score_web,stage_web)
